...
* Студент: [Даша Гусева](https://up.htmlacademy.ru/htmlcss/20/user/227487).
* Наставник: Пока догрызаю гранит науки одна.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/227487-device) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
